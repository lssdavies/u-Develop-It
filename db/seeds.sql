-- Remember, the parties will need to be created first, or the INSERT statements will fail due to the foreign key constraint we added to the candidates schema.
